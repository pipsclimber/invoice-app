 ...
 * Websites
 */
export const BASE_URL = "https://.vercel.app";
export const AUTHOR_WEBSITE = "";
export const AUTHOR_GITHUB = "https://github.com/hector-munachi";
 ...
 * Local storage
 */
export const LOCAL_STORAGE_INVOICE_DRAFT_KEY = "invoiceapp:invoiceDraft";
